...
//        v1.direccionAsistida = false;
        ...
        Vehiculo v1 = directorCitroen.getVehiculo();
...
//        System.out.println(v2.getPrestaciones());
        VehiculoDirector directorAuidi= new VehiculoDirector(new AudiBuilder());
        directorAuidi.construirVehiculo();
        Vehiculo v2 = directorAuidi.getVehiculo();
        System.out.println(v2.getPrestaciones());
//        
        //--------------------------------------------------
        ...
        VehiculoBase citroen = new RadioPantalla(new SistemasSensores(v1));
        ...
        VehiculoBase Auidi = new CamaraRetro(v2);
        System.out.println(Auidi.getPrestaciones());
        System.out.println(directorAuidi.getVehiculo().getPrestaciones());
    }
